...
export function LearnScreen() {
    ...
    return (
        <Box flex={1} bgColor="background">
            ...
            <ScrollView contentContainerStyle={{ paddingHorizontal: s(4), paddingVertical: s(6), gap: s(8), alignItems: "center" }}>
                {sections.map(section => (
                    <Box key={section.id} fullWidth maxW={size["max-content-width"]} gap={3}>
